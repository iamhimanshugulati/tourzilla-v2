        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-primary text-center" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="../../itstourzilla/hotel/index.php">Hotel</a>
              <a class="dropdown-item" href="../../itstourzilla/dinein/index.php">Dine-In</a>
              <a class="dropdown-item" href="../../itstourzilla/explore/index.php">Explore</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../../itstourzilla/blog/index.php">Blog</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../../itstourzilla/team/index.php">Team</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../../itstourzilla/contact/index.php">Contact</a>
          </li>
